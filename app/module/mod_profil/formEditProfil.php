    ...
    <div class="row">
        ...
        <div class="col-md-12">
            <article>
                ...
                <form action="module/mod_profil/aksiProfil.php" method="POST" enctype="multipart/form-data">
                    <fieldset>
                        ...
                        <div class="form-group">
                            ...
                            <input type="password" class="form-control" id="password" name="password" aria-describedby="password" value="<?php echo $user["password"] ?>" required>
                        </div>
                        <div class="form-group">

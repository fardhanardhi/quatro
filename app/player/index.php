...
if (!isset($_SESSION['as_player'])) { //jika session login bukan player
                ...
                <div class="row">
                    ...
                    <div class="col-md-8">
                        ...
                        <article>
                            ...
                            <p class="article-meta">Posted on <time datetime="2013-05-14">14 May</time> by <a href="#"
                                    rel="author">Joe Bloggs</a></p>

                            <p>Purchasing a template license for 8.00 GBP (at time of writing around 12 USD) gives you
